...
const fvSwipperObj = $(".js-swiper");
const pageTopButton = $(".js-page-top-pc");
const footerFixedMenu = $(".js-footer-shop-button");
...
$(function () {
  ...
  $(window).scroll(function () {
    ...
    const headerShopButton = $(".js-header-shop-button");
    let mvHeight = 0;
